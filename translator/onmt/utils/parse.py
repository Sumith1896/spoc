...
class ArgumentParser(cfargparse.ArgumentParser):
    ...
    def validate_preprocess_args(cls, opt):
        ...
        assert os.path.isfile(opt.train_src), \
            "Please check path of your train src file!"
        assert not opt.train_tgt or opt.train_tgt == '-' or os.path.isfile(opt.train_tgt), \
            "Please check path of your train tgt file!"
        ##########################################
        assert not opt.valid_src or os.path.isfile(opt.valid_src), \
            "Please check path of your valid src file!"
        assert not opt.valid_tgt or opt.valid_tgt == '-' or  os.path.isfile(opt.valid_tgt), \
