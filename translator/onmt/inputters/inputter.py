...
def build_vocab(train_dataset_files, fields, data_type, share_vocab,
    ...
    for i, path in enumerate(train_dataset_files):
        ...
        # sort_key is not needed here
        dataset = Dataset.load_jsonl(path, fields, None)
        ##########################################
...
class DatasetLazyIter(object):
    ...
    def __init__(self, dataset_paths, fields, sort_key, batch_size, batch_size_fn,
    ...
    def _iter_dataset(self, path):
        ################ MODIFIED ################
        #dataset = torch.load(path)
        cur_dataset = Dataset.load_jsonl(path, self.fields, self.sort_key)
        ##########################################
...
def build_dataset_iter(corpus_type, fields, sort_key, opt, is_train=True):
    """
    ...
    dataset_paths = list(sorted(
        glob.glob(opt.data + '.' + corpus_type + '*.gz')))
